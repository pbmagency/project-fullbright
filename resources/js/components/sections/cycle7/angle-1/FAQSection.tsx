...
const faqs: { category: string; q: string; a: string; node?: ReactNode }[] = [
    ...
    },
    {
        ...
        a: 'Setelah melakukan pendaftaran dan pembayaran, Kakak akan mendapatkan email berisi link serta akun untuk masuk ke Member Full Bright Di dalam Member Full Bright, Kakak dapat mengakses Video materi pembelajaran, E-Book Full Skill yang bisa kakak akses selama 2 tahun. Khusus untuk LMS Full Bright, Kakak dapat mengakses berbagai fitur pembelajaran selama 3 bulan, seperti Latihan Soal, Diagnostic Test, Drill, Tanya AI, Simulasi & Final Test Sementara itu, rekaman Live Zoom dapat diakses seumur hidup, sehingga Kakak bisa mengulang kembali materi kapan saja sesuai kebutuhan.',
    },
    {
