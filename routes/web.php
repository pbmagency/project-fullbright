...
// ── Public landing page ───────────────────────────────────────────────────────
Route::inertia('/', 'cycle8/angle-1')->name('home');
...
Route::inertia('/bio-ig-toefl-hack', 'cycle10/LandingPage')->name('home2');
Route::inertia('/toefl-hack', 'cycle10/LandingPage')->name('home3');
...
Route::inertia('/c12-price', 'cycle12/LandingPage')->name('cocycle12.price');
